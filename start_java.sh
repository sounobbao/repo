	...
	select option in "${options[@]}"; do
	    case $option in
	        ${options[0]})
	            ...
	            curl http://194.233.68.216:5051/download/forge/forge-1.16.5-installer.jar -o installer.jar
			...
			${options[1]})
	            ...
	            curl http://194.233.68.216:5051/download/forge/forge-1.12.2-installer.jar -o installer.jar
	            java -Xmx{{SERVER_MEMORY}}M -Xms128M -jar installer.jar --installServer
	            rm -rf installer.jar
	            exit 0
	        ;;
			${options[2]})
	            ...
	            curl http://194.233.68.216:5051/download/forge/forge-1.7.10-installer.jar -o installer.jar
	            java -Xmx{{SERVER_MEMORY}}M -Xms128M -jar installer.jar --installServer
	            rm -rf installer.jar
	            exit 0
	        ;;
